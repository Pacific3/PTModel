...
// PTModel
#define COCOAPODS_POD_AVAILABLE_PTModel
#define COCOAPODS_VERSION_MAJOR_PTModel 0
#define COCOAPODS_VERSION_MINOR_PTModel 1
#define COCOAPODS_VERSION_PATCH_PTModel 0
